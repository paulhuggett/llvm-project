...
; NOBEQ-NEXT:  # %bb.2: # %entry
; NOBEQ-NEXT:    jal zero, .LBB1_4
; NOBEQ-NEXT:  # %bb.3: # %cond_next18
; NOBEQ-NEXT:    addi a0, zero, 1
; NOBEQ-NEXT:  .LBB1_4: # %return
; NOBEQ-NEXT:    jalr zero, 0(ra)
entry:
...
; ALL-NEXT:    bne a1, zero, .LBB2_3
; ALL-NEXT:  # %bb.2: # in Loop: Header=BB2_1 Depth=1
; ALL-NEXT:    sltu a0, zero, a4
; ALL-NEXT:    jal zero, .LBB2_4
; ALL-NEXT:  .LBB2_3: # %atomicrmw.start
; ALL-NEXT:    # in Loop: Header=BB2_1 Depth=1
; ALL-NEXT:    slt a0, zero, a1
; ALL-NEXT:  .LBB2_4: # %atomicrmw.start
; ALL-NEXT:    # in Loop: Header=BB2_1 Depth=1
...
; ALL-NEXT:    lw a4, 0(sp)
; ALL-NEXT:    lw a1, 4(sp)
; ALL-NEXT:    beq a0, zero, .LBB2_1
; ALL-NEXT:  # %bb.5: # %atomicrmw.end
...
; ALL:       # %bb.0: # %entry
; ALL-NEXT:    andi a0, a0, 1
; ALL-NEXT:    bne a0, zero, .LBB3_2
; ALL-NEXT:  # %bb.1:
; ALL-NEXT:    vsetvli a0, zero, e8, mf8, ta, ma
; ALL-NEXT:    vmv.v.i v8, 0
; ALL-NEXT:    jalr zero, 0(ra)
; ALL-NEXT:  .LBB3_2: # %block1
; ALL-NEXT:    beq a0, zero, .LBB3_4
; ALL-NEXT:  # %bb.3: # %block2
; ALL-NEXT:    jalr zero, 0(ra)
; ALL-NEXT:  .LBB3_4: # %block3
; ALL-NEXT:    vsetvli a0, zero, e8, mf8, ta, ma
; ALL-NEXT:    vmv.v.i v8, 0
; ALL-NEXT:    jalr zero, 0(ra)
;
